...
SPECIES = {
    ...
    "Wild turkey": dict(kind="hunt", w=dict(temp=.20, trend=.12, rng=.10, front=.13, wind=.30, cloud=.15, moon=0),
                        temp=_temp_args("band", ideal=52, spread=45), wind=(0, 8, 20), moon="none"),
    "Coyote": dict(kind="hunt", w=dict(temp=.28, trend=.12, rng=.12, front=.18, wind=.18, cloud=.12, moon=0),
                   temp=_temp_args("cold", lo=5, hi=70), wind=(0, 10, 22), moon="none"),
    ...
    "Brook trout": dict(kind="fish", w=dict(temp=.45, trend=.25, rng=.10, front=.10, wind=.05, cloud=.05, moon=0),
                        temp=_temp_args("coldwater"), wind=(0, 10, 22), moon="none"),
    "Landlocked salmon": dict(kind="fish", w=dict(temp=.40, trend=.28, rng=.10, front=.10, wind=.06, cloud=.06, moon=0),
                              temp=_temp_args("coldwater"), wind=(0, 12, 24), moon="none"),
    "Lake trout (togue)": dict(kind="fish", w=dict(temp=.48, trend=.22, rng=.10, front=.08, wind=.06, cloud=.06, moon=0),
                               temp=_temp_args("coldwater"), wind=(0, 10, 22), moon="none"),
    "Northern pike": dict(kind="fish", w=dict(temp=.22, trend=.34, rng=.16, front=.12, wind=.10, cloud=.06, moon=0),
                          temp=_temp_args("band", ideal=66, spread=22), wind=(2, 14, 28), moon="none"),
    "Chain pickerel": dict(kind="fish", w=dict(temp=.20, trend=.34, rng=.18, front=.10, wind=.10, cloud=.08, moon=0),
                           temp=_temp_args("band", ideal=62, spread=26), wind=(2, 12, 25), moon="none"),
    "Yellow perch": dict(kind="fish", w=dict(temp=.25, trend=.28, rng=.20, front=.07, wind=.08, cloud=.12, moon=0),
                         temp=_temp_args("band", ideal=66, spread=18), wind=(0, 10, 22), moon="none"),
    "White perch": dict(kind="fish", w=dict(temp=.24, trend=.28, rng=.18, front=.08, wind=.10, cloud=.12, moon=0),
                        temp=_temp_args("band", ideal=68, spread=18), wind=(2, 12, 25), moon="none"),
    "Black crappie": dict(kind="fish", w=dict(temp=.24, trend=.30, rng=.16, front=.10, wind=.08, cloud=.12, moon=0),
                          temp=_temp_args("band", ideal=68, spread=18), wind=(0, 10, 22), moon="none"),
    "Panfish (sunfish)": dict(kind="fish", w=dict(temp=.30, trend=.26, rng=.18, front=.06, wind=.08, cloud=.12, moon=0),
                              temp=_temp_args("band", ideal=78, spread=20), wind=(0, 10, 22), moon="none"),
